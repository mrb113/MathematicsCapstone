...
Note that \textbf{TODO: Thing about the two matrices S and T}. 
...
We can show that terms $\underline{1}, \underline{2}$ and $\underline{3}$ are irreducible in $SL_{2}$ mod $3$. In $SL_{2}$ mod $3$, we know that orbits \textbf{TODO: list orbits} exist. We know that $\underline{1}$ is irreducible because \textbf{TODO}. $\underline{2}$ is \textbf{TODO}. $\underline{3}$ is irreducible because \textbf{TODO}.
